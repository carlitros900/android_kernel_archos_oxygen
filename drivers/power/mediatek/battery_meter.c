...
int __batt_meter_init_cust_data_from_dt(void)
{
	...
	of_node_put(np);
		...
		batt_meter_cust_data.q_max_pos_0=6600;
		batt_meter_cust_data.q_max_pos_25=6600;
		batt_meter_cust_data.q_max_pos_50=6600;
		batt_meter_cust_data.q_max_neg_10=6600;

		batt_meter_cust_data.q_max_pos_50_h_current=6468; //6600*0.98
		batt_meter_cust_data.q_max_pos_0_h_current=6468; 
		batt_meter_cust_data.q_max_pos_25_h_current=6468; 
#endif
