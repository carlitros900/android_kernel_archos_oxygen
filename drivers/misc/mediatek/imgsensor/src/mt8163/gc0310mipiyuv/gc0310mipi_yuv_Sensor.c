...
void GC0310MIPI_Sensor_Init(void)
{
  ...
  /////////////////////////////////////////////////
	...
	GC0310MIPI_write_cmos_sensor(0x95,0x32); 
...
*/
	...
	GC0310MIPI_write_cmos_sensor(0x27,0x04); //20fps
	GC0310MIPI_write_cmos_sensor(0x28,0xf8);  
	GC0310MIPI_write_cmos_sensor(0x29,0x05); //12.5fps
	GC0310MIPI_write_cmos_sensor(0x2a,0xcc); 
        ...
        MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    pSensorInfo->SensorDrivingCurrent = ISP_DRIVING_2MA;// 2ma
...
UINT32 GC0310MIPIYUVSetTestPatternMode(kal_bool bEnable)
{
    SENSORDB("[GC0310MIPIYUVSetTestPatternMode] Test pattern enable:%d\n", bEnable);
    if(bEnable)
    {
        GC0310MIPI_write_cmos_sensor(0xfe,0x00); //bit[4]: 1 enable test pattern, 0 disable test pattern
		GC0310MIPI_write_cmos_sensor(0xfa,0x11);
		GC0310MIPI_write_cmos_sensor(0x40,0x08);
		GC0310MIPI_write_cmos_sensor(0x41,0x00);
		GC0310MIPI_write_cmos_sensor(0x42,0x00);
		GC0310MIPI_write_cmos_sensor(0x4f,0x00);
		GC0310MIPI_write_cmos_sensor(0x18,0x06);
		//GC0310MIPI_write_cmos_sensor(0xfe,0x00);
		GC0310MIPI_write_cmos_sensor(0x77,0x40);
		GC0310MIPI_write_cmos_sensor(0x78,0x40);
		GC0310MIPI_write_cmos_sensor(0x79,0x40);
		...
		GC0310MIPI_write_cmos_sensor(0x70,0x40);
		GC0310MIPI_write_cmos_sensor(0x71,0x20);
		GC0310MIPI_write_cmos_sensor(0x72,0x40);
		GC0310MIPI_write_cmos_sensor(0x03,0x00);
		GC0310MIPI_write_cmos_sensor(0x04,0x00);
		GC0310MIPI_write_cmos_sensor(0x4c,0x01);
		//GC0310MIPI_write_cmos_sensor(0x4d,0x88);

	}
	else
	{
	    //GC0310MIPI_write_cmos_sensor(0x4c,0x20);//bit[0]: 1 enable test pattern, 0 disable test pattern
	}
    return ERROR_NONE;
}
...
//    UINT32 i;
	...
	UINT32 *feature_data=(UINT32 *) pFeaturePara;//add by tubao
    ...
    case SENSOR_FEATURE_SET_YUV_CMD:
		printk("zxl test 8611 0310 SENSOR_FEATURE_SET_YUV_CMD\n");
    ...
    case SENSOR_FEATURE_SET_VIDEO_MODE:    //  lanking
	 ...
	 // cyrille add for yidao
		case SENSOR_FEATURE_SET_TEST_PATTERN:
			GC0310MIPIYUVSetTestPatternMode((BOOL) *pFeatureData16);
			break;
...
// cyrille add for yidao end
    case SENSOR_FEATURE_CHECK_SENSOR_ID:
		GC0310MIPIGetSensorID(feature_data);
	break;
    default:
        break;
	}
