...
static inline unsigned int upmu_get_isink_ch0_en(void)
{
	unsigned int ret = 0;
	unsigned int val = 0;

	pmic_lock();
	ret = pmic_read_interface((unsigned int) (ISINK_EN_CTRL),
				    (&val),
				    (unsigned int) (PMIC_ISINK_CH0_EN_MASK),
				    (unsigned int) (PMIC_ISINK_CH0_EN_SHIFT)
	    );
...
static inline unsigned int upmu_get_isink_ch1_en(void)
{
	unsigned int ret = 0;
	unsigned int val = 0;
...
static inline unsigned int upmu_get_isink_ch2_en(void)
{
	unsigned int ret = 0;
	unsigned int val = 0;
...
static inline unsigned int upmu_get_isink_ch3_en(void)
{
	unsigned int ret = 0;
	unsigned int val = 0;
