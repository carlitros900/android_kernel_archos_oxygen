...
/* unsigned int fmod = 30;//Fmod = 30KHz by default */
	...
	void DSI_PHY_clk_change(DISP_MODULE_ENUM module, cmdqRecHandle cmdq,
				LCM_DSI_PARAMS *dsi_params) {
		int i = 0;
		unsigned int j = 0;
		unsigned int data_Rate = dsi_params->PLL_CLOCK * 2;
		...
		for (i = DSI_MODULE_BEGIN(module); i <= DSI_MODULE_END(module); i++) {
			if (0 != data_Rate) {
				...
				/* 1. PLL TXDIV Config */
				DSI_OUTREGBIT(cmdq, struct MIPITX_DSI_PLL_CON0_REG,
					      DSI_PHY_REG[i]->MIPITX_DSI_PLL_CON0,
					      RG_DSI0_MPPLL_TXDIV0, txdiv0);
				DSI_OUTREGBIT(cmdq, struct MIPITX_DSI_PLL_CON0_REG,
					      DSI_PHY_REG[i]->MIPITX_DSI_PLL_CON0,
				...
				DSI_OUTREGBIT(cmdq, struct MIPITX_DSI_PLL_CON2_REG,
					      DSI_PHY_REG[i]->MIPITX_DSI_PLL_CON2,
					      RG_DSI0_MPPLL_SDM_PCW_H, (pcw & 0x7F));
				DSI_OUTREGBIT(cmdq, struct MIPITX_DSI_PLL_CON2_REG,
					      DSI_PHY_REG[i]->MIPITX_DSI_PLL_CON2,
				...
				/* 3. SSC Config */
				if (1 != dsi_params->ssc_disable) {
					DSI_OUTREGBIT(cmdq, struct MIPITX_DSI_PLL_CON1_REG,
						      DSI_PHY_REG[i]->MIPITX_DSI_PLL_CON1,
						      RG_DSI0_MPPLL_SDM_SSC_PH_INIT, 1);
					DSI_OUTREGBIT(cmdq, struct MIPITX_DSI_PLL_CON1_REG,
							DSI_PHY_REG[i]->MIPITX_DSI_PLL_CON1,
					...
					pdelta1 =
					    (delta1 * data_Rate * txdiv * 262144 + 281664) / 563329;
					DSI_OUTREGBIT(cmdq, struct MIPITX_DSI_PLL_CON3_REG,
						      DSI_PHY_REG[i]->MIPITX_DSI_PLL_CON3,
						      RG_DSI0_MPPLL_SDM_SSC_DELTA, pdelta1);
					DSI_OUTREGBIT(cmdq, struct MIPITX_DSI_PLL_CON3_REG,
						      DSI_PHY_REG[i]->MIPITX_DSI_PLL_CON3,
			...
			DSI_OUTREGBIT(cmdq, struct MIPITX_DSI_PLL_CON1_REG,
				      DSI_PHY_REG[i]->MIPITX_DSI_PLL_CON1, RG_DSI0_MPPLL_SDM_FRA_EN,
				      1);
			DSI_OUTREGBIT(cmdq, struct MIPITX_DSI_PLL_TOP_REG,
				      DSI_PHY_REG[i]->MIPITX_DSI_PLL_TOP, RG_MPPLL_PRESERVE, 2);
