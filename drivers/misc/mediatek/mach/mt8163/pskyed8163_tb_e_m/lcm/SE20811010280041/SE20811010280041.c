...
static void lcm_get_params(LCM_PARAMS *params)
{
		...
		params->dsi.vertical_backporch					= 10;//8;//3; //6; //4; //6; //10;
		params->dsi.vertical_frontporch					= 12;//8;//6; //4//6; //10;
		params->dsi.vertical_active_line				= FRAME_HEIGHT; 

		params->dsi.horizontal_sync_active				= 24;//4;//5; //40; //44; //(120-40-40); //1;
...
LCM_DRIVER SE20811010280041_lcm_drv =
{
    .name			= "SE20811010280041_lcm_drv",
