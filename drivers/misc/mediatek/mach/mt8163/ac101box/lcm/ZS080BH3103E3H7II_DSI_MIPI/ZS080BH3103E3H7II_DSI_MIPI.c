...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.vertical_backporch					= 10;//16;  //4
	params->dsi.vertical_frontporch					= 12;//9;  //8
	params->dsi.vertical_active_line				= FRAME_HEIGHT;

	params->dsi.horizontal_sync_active			= 24;//18;  //14
	params->dsi.horizontal_backporch				= 24;//92;  //140
	params->dsi.horizontal_frontporch				= 72;//92; //16
	params->dsi.horizontal_active_pixel				= FRAME_WIDTH;
#endif
...
LCM_DRIVER ZS080BH3103E3H7II_DSI_MIPI_lcm_drv =
{
	.name = "ZS080BH3103E3H7II_DSI_MIPI",
