...
static void lcm_get_params(LCM_PARAMS *params)
{
		...
		params->dsi.horizontal_sync_active				= 4; //40; //44; //(120-40-40); //1;
...
data_array[0] = 0x00043902;
	...
	data_array[5] = 0x18212003; //03202118; 
...
LCM_DRIVER KD080D24_40NH_I6_MIPI_drv = 
{
    .name			= "KD080D24_40NH_I6_MIPI",
