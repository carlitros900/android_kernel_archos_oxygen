...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.word_count=800*3;
		...
		params->dsi.vertical_backporch					= 14;//3; //6; //4; //6; //10;
		params->dsi.vertical_frontporch					= 11;//8;//6; //4//6; //10;
		params->dsi.vertical_active_line				= FRAME_HEIGHT; 

		params->dsi.horizontal_sync_active				= 1;//5; //40; //44; //(120-40-40); //1;
		params->dsi.horizontal_backporch				= 32;//59;//44; //40; //44; //57;
		params->dsi.horizontal_frontporch				= 110;//16;//44; //40; //44; //32;
        ...
        params->dsi.PLL_CLOCK = 440;//380;//LCM_DSI_6589_PLL_CLOCK_NULL; //LCM_DSI_6589_PLL_CLOCK_396_5;
...
LCM_DRIVER TV101WUM_NH0_MIPI_lcm_drv = 
{
    .name			= "TV101WUM_NH0_MIPI_lcm_drv",
