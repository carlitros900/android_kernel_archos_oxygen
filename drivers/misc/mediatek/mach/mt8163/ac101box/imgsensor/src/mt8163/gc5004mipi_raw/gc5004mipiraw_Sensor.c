...
static imgsensor_info_struct imgsensor_info = {
    ...
    .checksum_value = 0xcddbb063,//0xb15d774b,        //checksum value for Camera Auto Test 
...
//1296x972
	...
	write_cmos_sensor(0x92, 0x00); //add  //mly  00 tao 9.26
	write_cmos_sensor(0x94, 0x07); //07  tao 9.26  
...
static void capture_setting(kal_uint16 currefps)
{
	...
	write_cmos_sensor(0x17, 0x15); 
	write_cmos_sensor(0x92, 0x00);//add //mly
	write_cmos_sensor(0x94, 0x0d);//0d //mly  0e  tao 9.26
	write_cmos_sensor(0x95, 0x07);
	write_cmos_sensor(0x96, 0x98);
	write_cmos_sensor(0x97, 0x0a);
	write_cmos_sensor(0x98, 0x20);
...
UINT32 GC5004MIPISetTestPatternMode(kal_bool bEnable)
{
    ...
    if(bEnable)
    {
        GC5004MIPI_write_cmos_sensor(0xfe,0x00); //bit[4]: 1 enable test pattern, 0 disable test pattern
		GC5004MIPI_write_cmos_sensor(0xb3,0x40);
		GC5004MIPI_write_cmos_sensor(0xb4,0x40);
		GC5004MIPI_write_cmos_sensor(0xb5,0x40);
		GC5004MIPI_write_cmos_sensor(0xb0,0x40);
		GC5004MIPI_write_cmos_sensor(0xb1,0x50);
		GC5004MIPI_write_cmos_sensor(0xb2,0x01);
		GC5004MIPI_write_cmos_sensor(0x03,0x00);
		GC5004MIPI_write_cmos_sensor(0x04,0x00);
	    GC5004MIPI_write_cmos_sensor(0x8c,0x01);

	}
	else
	{
	    GC5004MIPI_write_cmos_sensor(0x8c,0x00);//bit[4]: 1 enable test pattern, 0 disable test pattern
	}
    return ERROR_NONE;
}
...
//            break;
		//add by tubao
		case SENSOR_FEATURE_SET_TEST_PATTERN:
			GC5004MIPISetTestPatternMode((BOOL)*feature_data);
			break;
