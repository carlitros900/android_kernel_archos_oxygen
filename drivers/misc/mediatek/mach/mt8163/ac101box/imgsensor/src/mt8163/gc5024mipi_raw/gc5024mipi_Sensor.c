...
#define ANDROID_//LOG_INFO "GC5024_camera_Sensor"
/****************************   Modify end    *******************************************/
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x1f, 0x70);	
	write_cmos_sensor(0x20, 0x86);
	write_cmos_sensor(0x21, 0x0b);
	write_cmos_sensor(0x24, 0xb0); 							  
	write_cmos_sensor(0x29, 0x3b);	
	write_cmos_sensor(0x2d, 0x16); 							  								  
	write_cmos_sensor(0x2f, 0x77);	
	write_cmos_sensor(0x32, 0x49); 
	...
	write_cmos_sensor(0xd3, 0x43);	
	write_cmos_sensor(0xd8, 0x18); 	
	write_cmos_sensor(0xd9, 0x70);
	write_cmos_sensor(0xda, 0x03);
	write_cmos_sensor(0xdb, 0x30);
	write_cmos_sensor(0xdc, 0xba); 
	write_cmos_sensor(0xe2, 0x20); 
	write_cmos_sensor(0xe4, 0x70); 
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
	    ...
	    printk("zhangkai ===>>> come here  %s  sensor_id = 0x%x \n",__FUNCTION__,*sensor_id);
