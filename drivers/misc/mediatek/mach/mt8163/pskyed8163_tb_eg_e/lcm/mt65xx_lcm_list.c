...
LCM_DRIVER *lcm_driver_list[] = {
	...
	&lcm_common_drv,
#else
#if defined(ZS080BH3107E3H711)
	&ZS080BH3107E3H711_lcm_drv,
#endif
#if defined(KD080D24_40NH_A12)
	&KD080D24_40NH_A12_lcm_drv,
#endif
#if defined(HN116WX1_100_DSI_EDP_A15_A17)
	&hn116wx1_100_dsi_edp_A15_A17_lcm_drv,
#endif
#if defined(ZS101HE4026J7H4II)
	&zs101he4026j7h4ii_lcm_drv,
#endif
#if defined(KD122N4_40NH_A6_MIPI)
	&KD122N4_40NH_A6_MIPI_lcm_drv,
#endif
#if defined(KD080D24_40NH_A32)
	&KD080D24_40NH_A32_drv,
#endif
#if defined(LT080B21BA105_V00_MIPI)
	&LT080B21BA105_V00_MIPI_lcm_drv,
#endif
#if defined(HN116WX1_100_DSI_EDP_FHDANL)
	&hn116wx1_100_dsi_edp_fhdanl_lcm_drv,
#endif

#if defined(WG10111792881NA_WY_MIPI)
	&WG10111792881NA_WY_MIPI_drv,
#endif

#if defined(HN116WX1_100_DSI_EDP)
	&hn116wx1_100_dsi_edp_lcm_drv,
#endif

#if defined(SL089PC24Y0817_A00_DSI_MIPI)
	&SL089PC24Y0817_A00_DSI_MIPI_lcm_drv,
#endif
#if defined(ZS080BH3103E3H7II_DSI_MIPI)
	&ZS080BH3103E3H7II_DSI_MIPI_lcm_drv,
#endif
#if defined(SL008PN2D0882_A00)
	&SL008PN2D0882_A00_DSI_MIPI_lcm_drv,
#endif
#if defined(SL008PN21D1019_A00_MIPI)
	&SL008PN21D1019_A00_MIPI_lcm_drv,
#endif
#if defined(M080WXBI40_CA_01)
	&M080WXBI40_CA_01_lcm_drv,
#endif
//add by tubao
#if defined(SL101PC33Y0863_A00)
	&sl101pc33y0863a_lcm_drv,
#endif
//add by tubao
#if defined(LT070ME05000_MIPI)
	&LT070ME05000_MIPI_lcm_drv,
#endif
#if defined(KD089D7_40NI_A6_MIPI)
	&KD089D7_40NI_A6_drv,
#endif
//add by tubao
#if defined(KD101N42_40NA_C1_MIPI)
	&KD101N42_40NA_C1_MIPI_lcm_drv,
#endif
//add by tubao
#if defined(P101KDA_AP1)
	&P101KDA_AP1_lcm_drv,
#endif
#if defined(SE20811010280036)
	&SE20811010280036_lcm_drv,
#endif//add by tubao
#if defined(KD101N37_40NA_A5_REVA_MIPI)
	&KD101N37_40NA_A5_REVA_MIPI_drv,
#endif
//add by tubao
#if defined(KD101N37_40NA_A5_MIPI_T8611)
	&KD101N37_40NA_A5_MIPI_t8611emmc_lcm_drv,
#endif
//add by tubao
#if defined(SE20811010280041)
	&SE20811010280041_lcm_drv,
#endif
//add by tubao
#if defined(KD080D24_40NH_I6_MIPI)
	&KD080D24_40NH_I6_MIPI_drv,
#endif
//add by tubao
#if defined(TV101WUM_NH0_MIPI)
	&TV101WUM_NH0_MIPI_lcm_drv,
#endif
//add by alex
#if defined(TV097XOM_NS0_MIPI)
	&TV097XOM_NS0_MIPI_lcm_drv,
#endif
//add by alex
#if defined(PX101IH28810194A_MIPI)
	&PX101IH28810194A_MIPI_lcm_drv,
#endif

//add by tubao
#if defined(SL008PC21D1049_A00_MIPI)
	&SL008PC21D1049_A00_MIPI_lcm_drv,
#endif
#if defined(KD116N10_40NV_A8_MIPI)
	&KD116N10_40NV_A8_MIPI_lcm_drv,
#endif

#if defined(KD080D24_40NH_B3_MIPI)
	&KD080D24_40NH_B3_MIPI_drv,
#endif
#if defined(KD080D34_40NI_C6_DSI_MIPI)
	&KD080D34_40NI_C6_DSI_MIPI_lcm_drv,
#endif
...
#endif
#if defined(LXJC070WHM270_18A_RGB)
	&lxjc070whm270_18a_rgb_lcm_drv,
#endif
#if defined(LXJC070WHM270_18A_8370_RGB)
    &lxjc070whm270_18a_8370_rgb_lcm_drv,
#endif
...
#if defined(FY08021DI27A22_CB_MIPI)
	&FY08021DI27A22_CB_MIPI_lcm_drv,
#endif
