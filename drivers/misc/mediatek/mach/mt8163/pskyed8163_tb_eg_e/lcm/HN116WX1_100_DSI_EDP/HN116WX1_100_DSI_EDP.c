...
#else
	pr_info("[Kernel/LCM] lcm_init_power() enter\n");
#endif
}
...
#else
	pr_info("[Kernel/LCM] lcm_suspend_power() enter\n");
	lcm_set_gpio(0);
	MDELAY(20);
...
#else
	pr_info("[Kernel/LCM] lcm_resume_power() enter\n");
...
static void lcm_get_params(LCM_PARAMS *params)
{
		...
		params->dsi.horizontal_backporch				= 60;//43;//44; //40; //44; //57;
		params->dsi.horizontal_frontporch				= 60;//45;//108;//44; //40; //44; //32;
		...
		//params->dsi.fbk_div =45;
        	params->dsi.PLL_CLOCK = 180;//216;//240;//LCM_DSI_6589_PLL_CLOCK_NULL; //LCM_DSI_6589_PLL_CLOCK_396_5;
...
LCM_DRIVER hn116wx1_100_dsi_edp_lcm_drv = 
{
    .name			= "hn116wx1_100_dsi_edp",
