...
#define VOL_1000 1000000
	...
	printk("===============%s %d pinSetIdx=%d currSensorName=%s============\n",__func__,__LINE__, pinSetIdx, currSensorName);

	if (On) {

		ISP_MCLK1_EN(1);
		if (pinSetIdx == 0 && currSensorName && 
			((0 == strcmp(currSensorName, SENSOR_DRVNAME_GC2355_RAW)) || 
			(0 == strcmp(currSensorName, SENSOR_DRVNAME_GC2235_RAW)))) {
		...
		/*******************************************************************/	
			...
			((0 == strcmp(currSensorName, SENSOR_DRVNAME_GC0312_YUV)) || 
			(0 == strcmp(currSensorName, SENSOR_DRVNAME_GC0329_YUV)))) {
			printk("===============%s %d pinSetIdx=%d currSensorName=%s============\n",__func__,__LINE__, pinSetIdx, currSensorName);
			printk("===============%s %d pinSetIdx=%d currSensorName=%s============\n",__func__,__LINE__, pinSetIdx, currSensorName);
			printk("===============%s %d pinSetIdx=%d currSensorName=%s============\n",__func__,__LINE__, pinSetIdx, currSensorName);
			/* First Power Pin low and Reset Pin Low */
