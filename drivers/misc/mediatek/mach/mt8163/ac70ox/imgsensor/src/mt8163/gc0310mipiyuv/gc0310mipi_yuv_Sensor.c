...
#define GC0310MIPI_TEST_PATTERN_CHECKSUM (0xa8ccfa09)//(0x5593c632)// cyrille add  for yidao
...
void GC0310MIPI_Sensor_Init(void)
{
  ...
  /////////////////////////////////////////////////
	...
	GC0310MIPI_write_cmos_sensor(0x01,0x03);             
	GC0310MIPI_write_cmos_sensor(0x02,0x11);//00             
...
*/
	...
	*/
	GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
	GC0310MIPI_write_cmos_sensor(0x05, 0x00);
	GC0310MIPI_write_cmos_sensor(0x06, 0xd0); //HB
	GC0310MIPI_write_cmos_sensor(0x07, 0x00);
	GC0310MIPI_write_cmos_sensor(0x08, 0x42); //VB
	////row_time =60.13 us
	GC0310MIPI_write_cmos_sensor(0xfe, 0x01);
	GC0310MIPI_write_cmos_sensor(0x25, 0x00);   //anti-flicker step [11:8]
	GC0310MIPI_write_cmos_sensor(0x26, 0xa6);   //anti-flicker step [7:0]
       ////fps  
	GC0310MIPI_write_cmos_sensor(0x27, 0x01);   //exp level 0  30fps
	GC0310MIPI_write_cmos_sensor(0x28, 0xf2);    //if   level  < 0x0224 ,fps =30
	GC0310MIPI_write_cmos_sensor(0x29, 0x02);   //exp level 1  25.00fps
	GC0310MIPI_write_cmos_sensor(0x2a, 0x98);    //if   level  > 0x0224 ,fps = 1/(level * row_time)
	GC0310MIPI_write_cmos_sensor(0x2b, 0x03);   //exp level 2  20.00fps
	GC0310MIPI_write_cmos_sensor(0x2c, 0x3e); 
	GC0310MIPI_write_cmos_sensor(0x2d, 0x04);   //exp level 3  14.31fps
	GC0310MIPI_write_cmos_sensor(0x2e, 0x8a); 
	GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
...
UINT32 GC0310MIPIGetSensorID(UINT32 *sensorID)
{
    ...
    do {
        *sensorID=((GC0310MIPI_read_cmos_sensor(0xf0)<< 8)|GC0310MIPI_read_cmos_sensor(0xf1));
		printk("tubao ==>>> come here   GC0310MIPIGetSensorID   gc0310mipiyuv  sensorID = 0x%x  \n",*sensorID);
...
BOOL GC0310MIPI_set_param_banding(UINT16 para)
{
	switch (para)
	{
		...
		////////add  by handy,for 30 fps/////////
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
			GC0310MIPI_write_cmos_sensor(0x05, 0x00); 	
			GC0310MIPI_write_cmos_sensor(0x06, 0xd0); 
			GC0310MIPI_write_cmos_sensor(0x07, 0x00);
			GC0310MIPI_write_cmos_sensor(0x08, 0x42);
			
			GC0310MIPI_write_cmos_sensor(0xfe, 0x01);
			GC0310MIPI_write_cmos_sensor(0x25, 0x00);   //anti-flicker step [11:8]
			GC0310MIPI_write_cmos_sensor(0x26, 0x8b);   //anti-flicker step [7:0]
			
			GC0310MIPI_write_cmos_sensor(0x27, 0x01);   //exp level 0  30fps
			GC0310MIPI_write_cmos_sensor(0x28, 0xa1); 
			GC0310MIPI_write_cmos_sensor(0x29, 0x02);   //exp level 1  24fps
			GC0310MIPI_write_cmos_sensor(0x2a, 0xb7); 
			GC0310MIPI_write_cmos_sensor(0x2b, 0x03);   //exp level 2  19.9fps
			GC0310MIPI_write_cmos_sensor(0x2c, 0x42); 
			GC0310MIPI_write_cmos_sensor(0x2d, 0x04);   //exp level 3  13.29fps
			GC0310MIPI_write_cmos_sensor(0x2e, 0xe3); 
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00);
			/*
			GC0310MIPI_write_cmos_sensor(0xfe, 0x00); 
			GC0310MIPI_write_cmos_sensor(0x05, 0x02); 	
